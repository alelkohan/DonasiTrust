...
@section('content')
    ...
    <div class="relative my-6">
        ...
        <div class="relative flex justify-center text-xs uppercase"><span class="bg-white px-2 text-ink-500 font-medium">atau daftar dengan</span></div>
    </div>

    <a href="{{ route('auth.google') }}" class="flex w-full items-center justify-center gap-3 rounded-xl border border-ink-300 bg-white py-3 px-4 text-sm font-semibold text-ink-700 shadow-sm transition hover:bg-ink-50 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2">

...
<header x-data="{
...
}" class="fixed top-0 left-0 right-0 z-40 h-[60px] border-b border-white/10 bg-[#13111c]/95 text-white backdrop-blur-md transition-colors duration-300 print:hidden">
    <nav class="w-full h-full max-w-[1650px] mx-auto px-4 sm:px-6 lg:px-8 flex items-center gap-3" aria-label="Navigasi utama">
        ...
        <a href="{{ route('home') }}" class="flex shrink-0 items-center gap-2.5 group">
            <img src="{{ asset('images/logo-no-bg.png') }}" alt="DonasiTrust Logo" class="h-9 w-9 object-contain transition-transform group-hover:scale-105">

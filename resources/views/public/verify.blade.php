...
<div class="w-full max-w-3xl mx-auto py-12">
    ...
    <header class="text-center">
        ...
        <p class="mx-auto mt-3 max-w-lg text-sm text-slate-300 leading-relaxed">
            ...
            dan Kode Verifikasi (16 karakter). Tanpa perlu login.
        </p>
    </header>
        ...
        @if ($result['valid'])
            <div class="mt-8 overflow-hidden rounded-3xl border border-[#99ff04]/40 bg-[#1b182a] shadow-2xl">
                <div class="flex items-center gap-3 bg-[#99ff04] px-6 py-4 text-black font-black">
                    ...
                    <p class="text-base">Kuitansi Asli & Valid (Terdaftar di Platform Resmi)</p>
                </div>
        ...
        @else
            <div class="mt-8 rounded-3xl border border-rose-500/40 bg-[#1b182a] p-6 shadow-2xl">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="font-black text-rose-400 text-base">Kuitansi Tidak Cocok / Tidak Valid</p>
                        <p class="mt-1.5 text-xs leading-relaxed text-slate-300">
                            ...
                            tidak ditemukan atau kode verifikasinya tidak sesuai.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <form method="POST" action="{{ route('verifikasi.check') }}" class="mt-8 rounded-3xl border border-white/10 bg-[#1b182a] space-y-5 p-6 sm:p-8 shadow-2xl">
        ...
        <div>
            <label for="code" class="block text-xs font-extrabold text-slate-300 mb-1.5">Kode Verifikasi (16 Karakter)</label>
    ...
    <div class="mt-8 rounded-3xl border border-white/10 bg-[#1b182a] p-6">
        <h2 class="text-sm font-extrabold text-white">Bagaimana Kami Menjamin Keaslian Kuitansi?</h2>
        <p class="mt-2 text-xs leading-relaxed text-slate-300">
            Setiap kuitansi dilengkapi dengan Kode Verifikasi Keaslian Unik. Sistem otomatis mencocokkan kode ini dengan catatan transaksi resmi kami untuk memastikan kuitansi Anda 100% asli dan tidak dapat dipalsukan.
        </p>
    </div>
</div>
@endsection
